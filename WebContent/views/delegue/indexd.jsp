...
<%  DirecteurDao udao = new DirecteurDao("directeurs"); %>
        ...
        <li class="treeview">
          ...
          <li class="treeview">
                  ...
                  <ul class="treeview-menu active">
                      <li class="active"><a href="#">Liste des directeurs</a></li>
            ...
            <div class="col-xs-12">
              <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">Directeurs :</h3>
                </div>
                <div class="box-body">
                  ...
                  <tbody>
                     <% for (AbstractModel abstractModel : liste) { ds = (Directeurs) abstractModel; %>
								<tr>
									<td><%= ds.getId() %></td>
									<td><%= ds.getNom()%></td>
									<td><%= ds.getPrenom() %></td>
									...
									<td><%= ds.getExperienceProfessionnelle() %></td>
									 <td>
									<form role="form" method="post" action="${pageContext.request.contextPath}/SupprimerDirecteurServlet">
